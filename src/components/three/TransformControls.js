...
var TransformControlsGizmo = function () {
  ...
  var gizmoRotate = {
    ...
    // ],
    E: [
      [new Line(CircleGeometry(1.25, 1), matRed), null, [0, Math.PI / 2, 0]],
      [new Mesh(new CylinderGeometry(0.03, 0, 0.15, 4, 1, false), matRed), [1.17, 0, 0], [0, 0, - Math.PI / 2], [1, 1, 0.001]],
      [new Mesh(new CylinderGeometry(0.03, 0, 0.15, 4, 1, false), matRed), [- 1.17, 0, 0], [0, 0, Math.PI / 2], [1, 1, 0.001]],
      [new Mesh(new CylinderGeometry(0.03, 0, 0.15, 4, 1, false), matRed), [0, - 1.17, 0], [Math.PI, 0, 0], [1, 1, 0.001]],
      [new Mesh(new CylinderGeometry(0.03, 0, 0.15, 4, 1, false), matRed), [0, 1.17, 0], [0, 0, 0], [1, 1, 0.001]],
    ],
    XYZE: [
      [new Line(CircleGeometry(1, 1), matBlue), null, [0, Math.PI / 2, 0]]
    ]
  };
